    ...
    <table class="table table-lg">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{$item->judul}}</td>
                <td class="text-bold-500">{{$item->penulis}}</td>
                <td>{{$item->category->kategori_id}}</td>
                ...
                <td class="text-end">
                    ...
                    <a href="">
                        <button type="button" class="btn btn-danger " onclick="return confirm('apakah anda yakin?')"><i 
                                class="bi bi-trash"></i></button>
                    </a>
                </td>
            </tr>
